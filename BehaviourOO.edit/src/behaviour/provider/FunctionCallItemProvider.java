...
/**
 * This is the item provider adapter for a {@link behaviour.FunctionCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionCallItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionCall_funcName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionCall_funcName_feature", "_UI_FunctionCall_type"),
				 BehaviourPackage.Literals.FUNCTION_CALL__FUNC_NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviourPackage.Literals.FUNCTION_CALL__ARGUMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((FunctionCall)object).getFuncName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctionCall.class)) {
			case BehaviourPackage.FUNCTION_CALL__FUNC_NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case BehaviourPackage.FUNCTION_CALL__ARGUMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviourPackage.Literals.FUNCTION_CALL__ARGUMENTS,
