 ...
 * </p>
 * <ul>
 *   <li>{@link behaviour.impl.FunctionCallImpl#getFuncName <em>Func Name</em>}</li>
 *   <li>{@link behaviour.impl.FunctionCallImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionCallImpl extends ExpressionImpl implements FunctionCall {
	...
	protected EClass eStaticClass() {
		return BehaviourPackage.Literals.FUNCTION_CALL;
	}
	...
	public void setFuncName(String newFuncName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviourPackage.FUNCTION_CALL__FUNC_NAME, oldFuncName, funcName));
	}
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(Expression.class, this, BehaviourPackage.FUNCTION_CALL__ARGUMENTS);
		}
		return arguments;
	}
