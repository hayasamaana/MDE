 ...
 * </p>
 * <ul>
 *   <li>{@link behaviour.impl.ReturnStatementImpl#getReturnExpression <em>Return Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnStatementImpl extends StatementImpl implements ReturnStatement {
	...
	protected EClass eStaticClass() {
		return BehaviourPackage.Literals.RETURN_STATEMENT;
	}
	...
	public NotificationChain basicSetReturnExpression(Expression newReturnExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviourPackage.RETURN_STATEMENT__RETURN_EXPRESSION, oldReturnExpression, newReturnExpression);
	...
	public void setReturnExpression(Expression newReturnExpression) {
		if (newReturnExpression != returnExpression) {
			...
			if (returnExpression != null)
				msgs = ((InternalEObject)returnExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviourPackage.RETURN_STATEMENT__RETURN_EXPRESSION, null, msgs);
			if (newReturnExpression != null)
				msgs = ((InternalEObject)newReturnExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehaviourPackage.RETURN_STATEMENT__RETURN_EXPRESSION, null, msgs);
			msgs = basicSetReturnExpression(newReturnExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviourPackage.RETURN_STATEMENT__RETURN_EXPRESSION, newReturnExpression, newReturnExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviourPackage.RETURN_STATEMENT__RETURN_EXPRESSION:
