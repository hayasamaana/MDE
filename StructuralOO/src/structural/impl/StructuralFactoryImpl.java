...
public class StructuralFactoryImpl extends EFactoryImpl implements StructuralFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case StructuralPackage.PROGRAM: return createProgram();
			case StructuralPackage.CLASS: return createClass();
			case StructuralPackage.METHOD: return createMethod();
			case StructuralPackage.VARIABLE: return createVariable();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case StructuralPackage.DATA_TYPES:
				return createDataTypesFromString(eDataType, initialValue);
			case StructuralPackage.ACCESS_MOD:
	 ...
	 * @generated
	 */
	public structural.Class createClass() {
